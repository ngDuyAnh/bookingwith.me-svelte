...
<div class="flex items-center justify-center h-screen bg-gray-100">
    <div class="flex flex-col justify-center items-center p-4 bg-white shadow-lg rounded-lg w-full max-w-lg">
        ...
        {#if rating >= 1 && rating <= 2}
            ...
            <textarea bind:value={reviewText} class="border border-gray-300 p-2 mt-2 w-full h-32 rounded-md"
        ...
        {:else if rating === 5}
            ...
            {:else}
                ...
                <textarea disabled={isLoading} id="review-text" bind:value={reviewText}
                ...
                <div class="flex mt-2 space-x-2">
                    <button disabled={isLoading || !reviewText.trim() || isNumeric(reviewText)}
                            on:click={handlePolishReview}
                            class="text-white py-2 px-4 rounded-md {isLoading || !reviewText.trim() || isNumeric(reviewText) ? 'bg-purple-500' : 'bg-purple-500 hover:bg-purple-600'}">
                        {#if isLoading}
                            <Spinner/>
                            Polishing...
                        {:else}
                    ...
                    <button on:click={() => copyToClipboard(reviewText)}
