...
<!--    &lt;!&ndash;Left options&ndash;&gt;-->
<!--    <div class="justify-start">-->

<!--        &lt;!&ndash;Edit the booking&ndash;&gt;-->
<!--        {#if customerBooking.bookingState !== CustomerBookingState.COMPLETED}-->

<!--            &lt;!&ndash;Edit customer booking&ndash;&gt;-->
...
<!--        {:else}-->
<!--            &lt;!&ndash;Customer booking state is COMPLETED, show the option to send review reminder&ndash;&gt;-->
...
<!--                &lt;!&ndash;Customer booking state is APPOINTMENT OR LOBBY&ndash;&gt;-->
...
<!--                &lt;!&ndash;Customer booking state is SERVICING&ndash;&gt;-->
<!--                {#if customerBooking.bookingState === CustomerBookingState.SERVICING}-->
<!--                    <Button-->
