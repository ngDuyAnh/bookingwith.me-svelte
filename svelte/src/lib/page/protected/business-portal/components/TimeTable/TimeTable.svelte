<script>
    ...
    import EventModal from "$lib/page/protected/business-portal/components/TimeTable/EventModal/EventModal.svelte";
    ...
    $: if (
        ...
        fetchSchedule(isToday, selectedDate);
    }
    ...
    async function submitCustomerBooking(customerBooking) {
        ...
        // Update the schedule
        await fetchSchedule(isToday,selectedDate);
    }
...
<!--    bind:preselectEmployee={preselectEmployee}-->
<!--    bind:isToday={isToday}-->
<!--    bind:indicateToSendCustomerBookingToCompleted={indicateToSendCustomerBookingToCompleted}-->
