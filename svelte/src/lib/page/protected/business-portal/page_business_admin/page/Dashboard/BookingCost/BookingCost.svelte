<script>
    import {Alert, Button, Dropdown, Input, Label, Radio} from "flowbite-svelte";
    import {now, today} from "$lib/page/stores/now/now_dayjs_store.js";
    ...
    {
        return [
            {category: "Lobby Bookings", number: 0, costPerItem: dinero({amount:CustomerBookingCost.LOBBY,currency: 'CAD'}), totalCost: 0},
            {category: "Online Bookings", number: 0, costPerItem:dinero({amount:CustomerBookingCost.ONLINE,currency: 'CAD'}), totalCost: 0},
            {category: "SMS", number: 0, costPerItem: dinero({amount:CustomerBookingCost.SMS,currency: 'CAD'}), totalCost: 0},
...
{#if showInformation}
    <div class="h-auto overflow-y-auto p-4 flex md:flex-row flex-col md:items-stretch items-center md:justify-evenly justify-center text-green-800">
        <div class="flex flex-col bg-gray-50 sm:min-w-80 sm:max-w-xl w-full p-2 my-1 border-blue-100 rounded-lg border-2">
            <span class="mx-auto my-1 font-extrabold text-black">Bookings Made</span>
            <div class="flex flex-col justify-center items-center w-full">
                <table class="w-fit divide-y divide-gray-200">
                    ...
                    <tbody class="p-4 bg-white divide-y divide-gray-200">
                    <tr>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                            <span>Lobby</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <span>{bookingListInfo["lobbyBookings"]}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <span>{bookingListInfo["onlineBookings"]}</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <div class="flex flex-col bg-gray-50 sm:min-w-80 sm:max-w-xl w-full  p-2 my-1 border-blue-100 rounded-lg border-2">
            <span class="mx-auto my-1 font-extrabold text-black">SMS Sent</span>
            <div class="flex flex-col justify-center items-center w-full">
                <table class="w-fit divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <span>{bookingListInfo["confirmationSMS"]}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <span>{bookingListInfo["reminderSMS"]}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <span>{bookingListInfo["reviewSMS"]}</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
