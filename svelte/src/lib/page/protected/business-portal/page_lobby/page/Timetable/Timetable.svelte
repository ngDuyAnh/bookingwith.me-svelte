<script>
  ...
  } from "$lib/api/api_server/lobby-portal/api.js";
  ...
  import {
    ...
    formatToTime,
    formatToTimeAm,
  } from "$lib/application/Formatter.js";
  import Calendar from "@event-calendar/core";
  import ResourceTimeGrid from "@event-calendar/resource-time-grid";
  import { Modal } from "flowbite-svelte";
  import { getCustomerBooking } from "$lib/api/api_server/customer-booking-portal/api.js";
  import dayjs from "dayjs";
  import CustomerIndividualServiceBooking from "$lib/page/protected/business-portal/page_lobby/page/Dashboard/components/Servicing/CustomerIndividualBooking/CustomerIndividualServiceBooking/CustomerIndividualServiceBooking.svelte";
  import {
