<script>
    ...
    import {CustomerBookingState, CustomerBooking} from "$lib/api_server/customer-booking-portal/initialize_functions.js";
    import {forceSubmitBooking, submitBooking} from "$lib/api_server/customer-booking-portal/api.js";
